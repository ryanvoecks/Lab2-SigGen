...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+2,(vlSelf->count_incr));
    bufp->chgBit(oldp+3,(vlSelf->count_en));
    ...
    bufp->chgSData(oldp+9,(vlSelf->sigdelay__DOT__wr_addr),9);
    bufp->chgSData(oldp+10,((0x1ffU & ((IData)(vlSelf->sigdelay__DOT__wr_addr) 
                                       - (IData)(vlSelf->offset)))),9);
    bufp->chgSData(oldp+11,(vlSelf->count_incr),9);
}
