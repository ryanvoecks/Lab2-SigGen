...
VL_ATTR_COLD void Vsigdelay___024root__trace_init_sub__TOP__0(Vsigdelay___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+3,"count_incr", false,-1);
    tracep->declBit(c+4,"count_en", false,-1);
    ...
    tracep->pushNamePrefix("counter512 ");
    ...
    tracep->pushNamePrefix("ram512x8 ");
    tracep->declBus(c+13,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+14,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBit(c+1,"clk", false,-1);
...
VL_ATTR_COLD void Vsigdelay___024root__trace_full_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+3,(vlSelf->count_incr));
    bufp->fullBit(oldp+4,(vlSelf->count_en));
    ...
    bufp->fullSData(oldp+10,(vlSelf->sigdelay__DOT__wr_addr),9);
    bufp->fullSData(oldp+11,((0x1ffU & ((IData)(vlSelf->sigdelay__DOT__wr_addr) 
                                        - (IData)(vlSelf->offset)))),9);
    bufp->fullSData(oldp+12,(vlSelf->count_incr),9);
